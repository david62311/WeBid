...
<!-- BEGIN featured -->
<div class="col-md-3 col-sm-3 col-xs-12 img-portfolio">
<div class="featured-item">
<div class="item-ads-grid">
	<div class="img-grid">
		<div class="item-meta">
			<a href="{SITEURL}item.php?id={featured.ID}"><img class="img-responsive img-hover img-related img-thumbnail img-center" src="{featured.IMAGE}"></a>
		...
		<div class="bid-price">
			<span class="pull-left">{featured.BID}</span>
		</div>
	</div>
</div>
</div>
...
<div class="item-ads-grid">
	<div class="img-grid">
		<div class="item-meta">
			<a href="{SITEURL}item.php?id={hotitems.ID}"><img class="img-responsive img-hover img-related img-thumbnail img-center slideanim" src="{hotitems.IMAGE}"></a>
		...
		<div class="bid-price">
			<span class="pull-left">{hotitems.BID}</span>
		</div>
	</div>
</div>
</div>
